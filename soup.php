...
<body>
  ...
  <div class="menu">
    ...
    <a href="soup.php" class="current">Soup</a>
...
<!-- <div id="container"> -->
    ...
    <div id="main">
      ...
      $sql="SELECT * FROM products where id_product IN (4,5,6) ORDER BY name ASC";
...
<div class="col-xs-4">
              ...
              <div class="dishtitles"> <a href="soup.php?action=add&id=<?php echo $row['id_product'] ?>">Add to cart</a></div>
</div>
      <?php
      }
      ?>
