...
<body>
  ...
  <div class="menu">
    ...
    <a href="dessert.php" class="current">Desserts</a>
  </div>
  <p id="blank">
  </p>
<!-- <div id="container"> -->
    ...
    <div id="main">
      ...
      $sql="SELECT * FROM products where id_product IN (10,11,12) ORDER BY name ASC";
...
<div class="col-xs-4">
              ...
              <div class="dishtitles"> <a href="dessert.php?action=add&id=<?php echo $row['id_product'] ?>">Add to cart</a></div>
</div>
      <?php
      }
      ?>
